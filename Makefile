...
TRANSDIR      = texts
GENTRANSDIR   = $(SOURCEDIR)/translations
...
qthelp: prepare
	...
	@echo "# qcollectiongenerator $(BUILDDIR)/qthelp/NotesonOldEnglish.qhcp"
	@echo "To view the help file:"
	@echo "# assistant -collectionFile $(BUILDDIR)/qthelp/NotesonOldEnglish.qhc"
...
devhelp: prepare
	...
	@echo "Build finished."
	@echo "To view the help file:"
	@echo "# mkdir -p $$HOME/.local/share/devhelp/NotesonOldEnglish"
	@echo "# ln -s $(BUILDDIR)/devhelp $$HOME/.local/share/devhelp/NotesonOldEnglish"
	@echo "# devhelp"
